...
"""
train.py : 학습 관련 코드.
실행하는 폴더에 train.py, label.py, config.py, Dataset.py, kpf-bert, kpf-bert-ner, kor-bert-ner 폴더가 있어야함.
입력 형태 : python train.py -s TRAIN_FILE -o MODEL_NAME (ex. python train.py -s dataset/21_150tags_EntityLinking/NXEL2102203310/NXEL2102203310.json -o kpfbert-ner)
