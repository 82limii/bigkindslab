...
def ner_predict(text):
    model = BertForTokenClassification.from_pretrained("D:/Users/user/bigkinds/kpf-BERT-ner4")
    tokenizer = AutoTokenizer.from_pretrained("D:/Users/user/bigkinds/kpfbert")
    text = text.replace('\n','')
